...
const apparelItems = [
  {
    ...
    design: 'Two beloved cereal mascots dancing together on a vibrant rainbow stage! This tee captures the pure joy of breakfast with fun characters, colorful rainbow platforms, and sparkles everywhere. Perfect for cereal lovers and anyone who starts their day with a smile.',
    price: '$27.99',
  ...
  },
  {
    ...
    design: 'An epic food festival scene with cereal characters performing on stage! Crowd of adorable mascots cheering below, banner proudly displaying "FOOD-A-PALOOZA" in golden letters. It\'s a celebration of breakfast fun and colorful chaos.',
    price: '$41.99',
  ...
  },
  {
    ...
    design: 'Cereal characters diving and swimming in a giant rainbow bowl of cereal! Colorful splashes, bright sunshine, and pure breakfast joy. This design screams fun, energy, and delicious mornings.',
    price: '$24.99',
    colors: ['Black', 'White', 'Navy'],
    sizes: ['S', 'M', 'L', 'XL', '2XL'],
    material: '100% Premium Cotton',
  ...
  },
  {
    ...
    design: 'Cereal mascot chilling at the beach in a rainbow-striped cup with whipped cream topping! Pink sandy vibes, relaxed energy, and pure summer breakfast vibes. Perfect for beach lovers and chill vibes enthusiasts.',
    price: '$27.99',
    colors: ['Black', 'White', 'Navy'],
    sizes: ['S', 'M', 'L', 'XL', '2XL'],
    material: '100% Premium Cotton',
